...
with col1:
    with st.container(border=True):
        st.markdown("<h3 style='text-align: center; color: black; margin-bottom: 1rem;'>Impact Score</h3>", unsafe_allow_html=True)
...
with col2:
    with st.container(border=True):
        st.markdown("<h3 style='text-align: center; color: black; margin-bottom: 1rem;'>Sentiment Breakdown</h3>", unsafe_allow_html=True)
